...
const ChinAIChatbot = () => {
  ...
  const getBotResponse = (userMessage) => {
    ...
    } else if (thanks.some(t => lowerMsg.includes(t))) {
      return "You're welcome! Happy to help 💙";
    } else if (lowerMsg.includes('your name') || lowerMsg.includes('who are you')) {
      return "I'm Chin-AI, your intelligent assistant! Ask me anything 😊";
    } else if (lowerMsg.includes('help')) {
      return "I'm here to help! Just ask me any question and I'll do my best to assist you 🚀";
    } else {
      const responses = [
        "I'm still learning, but I'll try to help 😊",
        "That's an interesting question! I'm expanding my knowledge every day 🌟",
        "I don't have a perfect answer yet, but I'm here to assist however I can 💫",
        "Great question! I'm still developing my understanding of that topic 🔮"
      ];
  ...
  const handleSendMessage = () => {
    ...
    // Simulate bot thinking with "aiich aiich aiich..." delay
    setTimeout(() => {
      setIsTyping(false);
      const botMessage = {
        type: 'bot',
      ...
      <div className="welcome-container">
        ...
        <div className="welcome-content">
            ...
            <div className="avatar">
              <div className="avatar-inner">
                <svg viewBox="0 0 100 100" className="avatar-icon">
                  ...
                  <circle cx="50" cy="35" r="15" fill="url(#avatarGrad)" />
                  <path d="M 30 55 Q 50 45 70 55 L 70 75 Q 50 85 30 75 Z" fill="url(#avatarGrad)" />
                  <circle cx="43" cy="32" r="3" fill="#0a0a1f" />
                  <circle cx="57" cy="32" r="3" fill="#0a0a1f" />
                </svg>
              </div>
            </div>
          </div>
          ...
          <h1 className="welcome-title">
            <span className="glitch-text" data-text="Welcome to Chin-AI">Welcome to Chin-AI</span>
          </h1>
          
          <p className="welcome-subtitle">Your intelligent assistant</p>
        ...
        <style jsx>{`
          ...
          .avatar-inner {
            animation: rotateAvatarInner 20s linear infinite reverse;
          }

          @keyframes rotateAvatarInner {
            from { transform: rotate(0deg); }
            to { transform: rotate(360deg); }
          }
          ...
          @keyframes glitchAnimation {
            ...
            92% {
              text-shadow: 
                ...
                -2px 0 20px rgba(0, 245, 255, 0.8);
            }
            94% {
              text-shadow: 
                -2px 0 10px rgba(0, 245, 255, 0.8),
                2px 0 20px rgba(255, 0, 255, 0.8);
            }
          }
    ...
    <div className="chat-container">
      ...
      <div className="chat-header">
        <div className="header-avatar">
          <div className="header-avatar-glow"></div>
          <svg viewBox="0 0 100 100" className="header-avatar-icon">
            <defs>
            ...
            <circle cx="50" cy="35" r="15" fill="url(#headerGrad)" />
            <path d="M 30 55 Q 50 45 70 55 L 70 75 Q 50 85 30 75 Z" fill="url(#headerGrad)" />
            <circle cx="43" cy="32" r="3" fill="#0a0a1f" />
            <circle cx="57" cy="32" r="3" fill="#0a0a1f" />
          </svg>
        </div>
        <div className="header-info">
          <h2 className="header-title">Chin-AI</h2>
          ...
          >
            {message.type === 'bot' && (
              <div className="message-avatar">
                <svg viewBox="0 0 100 100" className="message-avatar-icon">
                  <circle cx="50" cy="35" r="15" fill="url(#headerGrad)" />
                  <path d="M 30 55 Q 50 45 70 55 L 70 75 Q 50 85 30 75 Z" fill="url(#headerGrad)" />
                  <circle cx="43" cy="32" r="3" fill="#0a0a1f" />
                  <circle cx="57" cy="32" r="3" fill="#0a0a1f" />
          ...
          <div className="message bot typing-message">
            ...
            <div className="message-bubble typing-bubble">
              <div className="typing-indicator">
                <span className="typing-text">aiich</span>
                <span className="typing-text">aiich</span>
                <span className="typing-text">aiich</span>
      ...
      <style jsx>{`
        * {
        ...
        .typing-message {
          animation: messageSlideIn 0.4s ease-out, typingPulse 1.5s ease-in-out infinite;
        }
